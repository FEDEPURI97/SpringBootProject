...
import com.federicopuricella.jobportal.services.JobPostActivityService;
import com.federicopuricella.jobportal.services.JobSeekerApplyService;
import com.federicopuricella.jobportal.services.JobSeekerSaveService;
import com.federicopuricella.jobportal.services.UsersService;
    ...
    public String searchJobs(Model model, @RequestParam(value = "job",required = false)String job,
        ...
        if(!(authentication instanceof AnonymousAuthenticationToken)){
            ...
            if(authentication.getAuthorities().contains(new SimpleGrantedAuthority(
                    ("Recruiter")))){
            List<RecruiterJobsDto>recruiterJob=jobPostActivityService.getRecruiterJobs(((RecruiterProfile)
